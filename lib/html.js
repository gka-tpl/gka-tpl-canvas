module.exports = function html(data, names, prefix, frameduration) {
...
<body>
    ...
    loadImage(imgNames, function() {
        ...
        setInterval(function(){
            ...
            ctx.drawImage((imgs[data.file] || imgs[o.file]), o.x, o.y, o.width, o.height, o.offX, o.offY, o.width, o.height);
            i = ++i === len? 0: i;
        }, ${frameduration})
    }, "img/")
    </script>
